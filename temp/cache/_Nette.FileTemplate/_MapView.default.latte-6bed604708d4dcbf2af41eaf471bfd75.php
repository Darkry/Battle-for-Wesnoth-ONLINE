<?php //netteCache[01]000420a:2:{s:4:"time";s:21:"0.49309400 1313602136";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:98:"C:\Program Files (x86)\EasyPHP-5.3.3.1\www\Wesnoth\app\FrontModule\templates\MapView\default.latte";i:2;i:1313602134;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"bf2f6c0 released on 2011-07-13";}}}?><?php

// source file: C:\Program Files (x86)\EasyPHP-5.3.3.1\www\Wesnoth\app\FrontModule\templates\MapView\default.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'ehoxhjvoub')
;//
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lba78c61af42_head')) { function _lba78c61af42_head($_l, $_args) { extract($_args)
?>
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb80778f7892_content')) { function _lb80778f7892_content($_l, $_args) { extract($_args)
?>
...
// block _units
//
if (!function_exists($_l->blocks['_units'][] = '_lbb69d8ee95f__units')) { function _lbb69d8ee95f__units($_l, $_args) { extract($_args); $control->validateControl('units')
?>
<div id="units">
